//
//  TiDocumentpickerExampleProxy.swift
...
@objc(TiDocumentpickerExampleProxy)
class TiDocumentpickerExampleProxy: TiProxy {

  override func _init(withPageContext context: TiEvaluator!) -> TiDocumentpickerExampleProxy! {
